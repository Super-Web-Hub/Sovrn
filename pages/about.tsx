      ...
      <main className="main-content">
        <section className="about-hero">
          ...
          <p className="about-subtitle">
            Mobile-first social-commerce platform for creators
          </p>
        </section>
        ...
        <section className="about-content">
          ...
          <div className="about-sections">
            <div className="about-section">
              <h2>Our Mission</h2>
              <p>
                Afleuncer empowers content creators to monetize their influence
                through authentic product recommendations. We believe in
                transparent, value-driven affiliate marketing that benefits both
            ...
            <div className="about-section">
              ...
              <ul className="features-list">
                <li>
                  📱 Mobile-optimized interface for seamless user experience
                </li>
            ...
            <div className="about-section">
              ...
              <p>
                Afleuncer provides a streamlined platform for content creators
                to share product recommendations while maintaining transparency
                with their audience. Our mobile-first approach ensures optimal
          ...
          <div className="contact-section">
            ...
            <div className="contact-info">
              ...
              <div className="contact-item">
                ...
                <p>Email: jgewirz@gmail.com</p>
                <p>Partnership: Wirzyuny@gmail.com</p>
              </div>
            </div>
          </div>
        </section>
